setInterval(() => {
	...
	const correct1 = 'Погода отличная!';
	...
	const correct3 = 'Пора заняться учебой';
	...
	const correct4 = 'Присоединение к клубу недоступно';
	...
	const correct5 = 'Сегодня не пятница';
